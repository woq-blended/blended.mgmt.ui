...
class PrintlnLogger(className: String) extends Logger {
  override def error(msg: => String, throwable: Throwable) : Unit = log("ERROR", msg, throwable)
  override def warn(msg: => String, throwable: Throwable) : Unit = log("WARN", msg, throwable)
  override def info(msg: => String, throwable: Throwable) : Unit = log("INFO", msg, throwable)
  override def debug(msg: => String, throwable: Throwable) : Unit = log("DEBUG", msg, throwable)
  override def trace(msg: => String, throwable: Throwable) : Unit = log("TRACE", msg, throwable)
